...
function pergantian() {
  ...
  setTimeout(gantikata, 4000);
  setTimeout(gantikata, 8000);
  setTimeout(gantikata, 12000);
  setTimeout(gantikata, 14000);
  setTimeout(gantikata, 19000);
  setTimeout(gantikata, 25000);
  setTimeout(gantikata, 30000);
  setTimeout(gantikata, 31000);
  setTimeout(gantikata, 35000);
}
function tfkata() {
  fkata += 1;
}
